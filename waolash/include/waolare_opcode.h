...
typedef enum waolare_opcode {
	wre_undefined,
	wre_getaddrinfo			= 0x0001, /**< Gonna resolve hostname into IP address; provided data is a UTF8-encoded hostname */
	...
	wre_getaddrinfo_failed	= 0x0004, /**< IP address resolution failed; provided data is a UTF8-encoded hostname */
	...
	wre_gotnameinfo			= 0x0010, /**< Successfully resolved IP address into hostname; provided data is a UTF8-encoded hostname */
